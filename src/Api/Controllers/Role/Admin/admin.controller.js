...
const createAdmin = async (req, res) => {
  try {
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(`4292035840_29_4_29_52_11`, 'Error registering admin:', error)
    );
    res
      .status(400)
...
const loginAdmin = async (req, res) => {
  try {
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(`4292035840_82_4_82_51_11`, 'Error logging in admin:', error)
    );
    res
      .status(400)
...
const updateAdmin = async (req, res) => {
  try {
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(`4292035840_126_4_126_49_11`, 'Error updating admin:', error)
    );
    res
      .status(400)
...
const getAdminById = async (req, res) => {
  try {
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(
        `4292035840_151_4_151_57_11`,
        'Error retrieving admin by ID:',
        error
      )
    );
    res
...
const deleteAdmin = async (req, res) => {
  try {
    ...
    /* eslint-disable */ console.error(
      ...oo_tx(`4292035840_168_4_168_49_11`, 'Error deleting admin:', error)
    );
    res
      .status(400)
...
/* istanbul ignore next */ function oo_tx(i, ...v) {
  try {
