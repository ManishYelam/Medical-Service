...
module.exports = {
    ...
    bulkCreateDepartments: async (req, res) => {
        try {
            ...
            const parseData = (row) => {
                ...
                const formattedDateFounded = year ? new Date(`${year}-${month}-${day}`).toISOString() : null;
            ...
            const departmentsResult = await departmentService.bulkCreateDepartments(departments);
    ...
    getAllDepartments: async (req, res) => {
        try {
            ...
            const { departments, totalDepartments, totalPages } = await departmentService.getAllDepartments(
                filters,
                search,
                parseInt(page),
                parseInt(pageSize),
