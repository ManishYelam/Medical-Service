...
emailRouter
  ...
  .post(
    '/send-registration-email/:userId',
    emailController.sendRegistrationEmail
  )

  .post(
    '/send-password-change-email/:userId',
    emailController.sendPasswordChangeEmail
  )

  // Route to send performance tracking email
  .post(
    '/send-performance-tracking-email/:userId',
    emailController.sendPerformanceTrackingEmail
  )
  ...
  .post(
    '/send-notification-email/:userId',
