...
RoleRouter.post('/register', validate(registerSchema), register)
  ...
  .post(
    '/logout',
    authenticateRole(['SuperAdmin', 'Admin', 'Moderator', 'User']),
    logout
  )
  ...
  .post(
    ...
    authenticateRole(['SuperAdmin', 'Admin', 'Moderator', 'User', 'Guest']),
    refreshToken
  )
  ...
  .get(
    '/moderator-only',
    authenticateRole(['SuperAdmin', 'Admin', 'Moderator']),
    (req, res) => {
